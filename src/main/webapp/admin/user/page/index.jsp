...
<head>
    ...
    <script type="text/javascript" src="${path}/common/js/require.js" data-main="${path}/common/js/main.js"
            async="false"></script>
</head>
...
<div data-options="region:'north',split:false" title="" style="overflow: hidden; height: 70px;
    ...
    <div style="padding-left:10px;padding-top:17px; font-size: 20px; "><img src="../images/blocks.gif" width="20"
                                                                            height="20" align="absmiddle"/>传销管理系统
    </div>
</div>
