...
$(function(){
	...
	datagrid=$('#tt').datagrid({
		...
		columns:[[
		          ...
		          {title:'姓名',   field:'userName', width:'100',align:'center',              editor: { type:'validatebox', options: { required: true,validType:['CHS','length[2,4]']}},															   formatter:function(value,rowIndex,rowData){return '<span title="'+value+'">'+value+'</span>';}},
	              {title:'性别',   field:'userSex',  width:'100',align:'center',sortable:true,editor: { type:'combobox',    options: { required: true,data: pipingLevel,  valueField:"value",  textField:"text",editable: false,  panelHeight:45,}},formatter:function(value,rowIndex,rowData){return '<span title="'+value+'">'+value+'</span>';}},
		          {title:'年龄',   field:'userAge',  width:'100',align:'center',sortable:true,editor: { type:'validatebox', options: { required: true,validType:['Age']}},              															   formatter:function(value,rowIndex,rowData){return '<span title="'+value+'">'+value+'</span>';}},			 
			      {title:'手机号码',field:'userPhone',width:'100',align:'center',              editor: { type:'validatebox', options: { required: true,validType:['Mobile']}},           															   formatter:function(value,rowIndex,rowData){return '<span title="'+value+'">'+value+'</span>';}}
		          ]],
		//数据加载之前
